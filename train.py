...
def main() -> None:
    ...
    experiment_name = os.getenv("MLFLOW_EXPERIMENT_NAME", "assignment5_pipeline")
    ...
    with mlflow.start_run() as run:
        ...
        # Optional override is useful to demonstrate failed/successful pipeline runs.
        forced_accuracy = os.getenv("FORCE_ACCURACY")
        if forced_accuracy is not None:
